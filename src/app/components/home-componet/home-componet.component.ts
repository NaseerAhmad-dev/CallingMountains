...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, ScrollTopModule ,ContactUsComponent, ChatComponentComponent, RouterOutlet, HerosectionComponent, DisplayPackageComponent, PackagesComponent, PlacesToVisitComponent, ClientReviewsComponent, WebFooterComponent, SwipePagesComponentComponent],
